  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterApp.jobHistory.home.createOrEditLabel">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="FRENCH">{translate('jhipsterApp.Language.FRENCH')}</option>
                  <option value="ENGLISH">{translate('jhipsterApp.Language.ENGLISH')}</option>
                  <option value="SPANISH">{translate('jhipsterApp.Language.SPANISH')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
